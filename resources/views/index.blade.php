						...
						<div class="row">
							<div class="col-md-7">
								<div class="home-content wow fadeInLeft" data-wow-offset="10" data-wow-delay="1.2s">
									...
									<p class="home-content2 wow fadeInLeft" data-wow-offset="10" data-wow-delay="1.8s"><a href="#MAPA"> - O que podemos fazer pra não sermos atacados? </a></p>
			...
			<div class="container">
				...
				<div class="hp-text-container">
					<div class="row text-center">
						<div class="col-md-5">
							<img src="img/hpot.png" class="hpot-img text-center wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.6s">
						</div>
						<div class="col-md-7">
							...
							Deception Toolkit (DTK), Cyber Cop Sting, Honeyd, KFsensor, Nepenthes, Dionaea, BackOfficer Friendly (BOF), Specter e Valhala;</p>
